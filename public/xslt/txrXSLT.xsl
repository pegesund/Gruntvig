...
-->
    ...
    <xsl:template match="TEI:TEI">
        ...
        <div class="mainTxr">
            ...
            <xsl:choose>
                <xsl:when test="document(//TEI:note[@type='txt']/@target)//TEI:TEI/TEI:teiHeader/TEI:fileDesc/TEI:notesStmt/TEI:note[@type='txr']">
                    <div class="content">
        ...
        <xsl:choose>            
            <xsl:when test="@type='textualCriticismPluralis'">                
                ...
                <table class="textualCriticism">
                    ...
                    <xsl:for-each select="document(//TEI:note[@type='txt']/@target)//TEI:app[@select]">
                        <xsl:choose>
